  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Discover the ease of dining with Restaurant Booking Engine - where customers effortlessly reserve tables and restaurant staff efficiently manage reservations and menus."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Discover the ease of dining with Restaurant Booking Engine - where customers effortlessly reserve tables and restaurant staff efficiently manage reservations and menus.`}
            </Text>
            <Box
